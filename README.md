...
<p align="center">
    <a href="https://www.jsdelivr.com/package/gh/ColonelParrot/docuSnap"><img src="https://data.jsdelivr.com/v1/package/gh/ColonelParrot/docuSnap/badge"></a>
    <a href="https://cdnjs.com/libraries/docuSnap"><img src="https://img.shields.io/cdnjs/v/docuSnap"></a>
    <a href="https://npmjs.com/package/docuSnap"><img src="https://badgen.net/npm/dw/docuSnap"></a>
    <br />
    <a href="https://github.com/puffinsoft/docuSnap/blob/master/LICENSE"><img src="https://img.shields.io/github/license/puffinsoft/docuSnap.svg"></a>
    <a href="https://npmjs.com/package/docuSnap"><img src="https://badgen.net/npm/v/docuSnap"></a>
</p>

<p align="center">
  <a href="https://npmjs.com/package/docuSnap"><img src="https://nodei.co/npm/docuSnap.png"></a>
</p>
...
<br/>
Available on <a href="https://www.npmjs.com/package/docuSnap">npm</a> or via <a href="https://www.jsdelivr.com/package/gh/ColonelParrot/docuSnap">cdn</a><br/>
</p>
...
<h3 align="center" margin="0"><a href="https://github.com/puffinsoft/docuSnap/wiki">➡️ view documentation</a></h3>

<hr/>

## Quickstart

> **Developers Note**: you can now use the [docuSnap debugging tool](https://colonelparrot.github.io/docuSnap/tester.html) to observe the result (highlighting, extraction) on test images.
...
<script src="https://cdn.jsdelivr.net/gh/ColonelParrot/docuSnap@master/src/docusnap.min.js"></script>
```

> **Note**: docuSnap on NodeJS is slightly different. See [wiki: use on NodeJS](https://github.com/puffinsoft/docuSnap/wiki/Getting-started#use-on-nodejs).
...
- we recommend wrapping your code using `docuSnap` in a window `load` event listener to ensure OpenCV is loaded
